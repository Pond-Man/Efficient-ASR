...
#!/usr/bin/env python3
"""Recipe for training a Citrinet ASR system with librispeech.
The system employs an encoder and CTC greedy decoding.

The system employs the citrinet model and CTC.
Training is performed on the 100h LibriSpeech dataset.

Based off of https://github.com/speechbrain/speechbrain/blob/develop/recipes/LibriSpeech/ASR/CTC/train.py, credit
to original authors: 
...
class ASR(sb.core.Brain):
    def compute_forward(self, batch, stage):
        ...
        # forward modules
        enc_out = self.modules.enc(feats)
